...
════════════════════════════════════════════════════════════
  ...
  ╔══════════════════════════════════════════════════════╗
  ║  עצור. מה שמודפס מיד אחרי השורה הזאת הוא מפתח פרטי.  ║
  ║                                                      ║
  ║  הוא פותח את השרת כ-root. הוא הולך למקום אחד בלבד —  ║
  ║  שדה הסוד בגיטהאב. לא לצ'אט, לא למייל, לא לוואטסאפ,  ║
  ║  לא לצילום מסך, וגם לא כשמעתיקים "את כל הפלט" כדי    ║
  ║  לשאול על משהו אחר — שם בדיוק הוא דלף בפעם הקודמת.   ║
  ║                                                      ║
  ║  אם הוא בכל זאת נחשף, ביטול לוקח שנייה:              ║
  ║  sed -i '/karnaf-github-actions/d' ~/.ssh/authorized_keys
  ╚══════════════════════════════════════════════════════╝

  להעתיק את הכול בין השורות הבאות, כולל BEGIN ו-END:
