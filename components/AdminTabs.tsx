...
export default function AdminTabs({ overview, reliability, logic, rules, deals, tables }: {
  overview: ReactNode; reliability: ReactNode; logic: ReactNode; rules: ReactNode; deals: ReactNode; tables: ReactNode;
}) {
  const [tab, setTab] = useState<(typeof TABS)[number]["key"]>("overview");
  const panes: Record<string, ReactNode> = { overview, reliability, logic, rules, deals, tables };
