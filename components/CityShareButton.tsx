...
export default function CityShareButton({ href, cityName }: { href: string; cityName: string }) {
  return (
    <a
      ...
      className="chip-action border-emerald-200 bg-emerald-50 text-emerald-700 hover:bg-emerald-100"
    ...
    >
      ...
      {/* label hidden on a phone: the icon plus title carry it, and those 50px
          are what keeps the city header on ONE row at 375px. */}
      <span className="hidden sm:inline">שלח לחבר</span>
    </a>
  );
}
