...
function calc(raw: {
  ...
  const population_growth_pct = population_growth_abs !== null && population_2021 ? population_growth_abs / population_2021 : null;
  ...
  const price_change_pct = price_per_sqm_2026 !== null && price_per_sqm_2023 ? (price_per_sqm_2026 - price_per_sqm_2023) / price_per_sqm_2023 : null;
