      ...
      <div className="mx-auto max-w-3xl px-4">
        ...
        <Section title="מה אנחנו אוספים">
          ...
          <p className="mt-2">
            ...
            רואים אותו ברמת המשתמש. בגלישה ללא חשבון הרישום אינו מקושר לזהות כלשהי — הוא נושא
            מזהה אקראי של לשונית הדפדפן בלבד, שנעלם עם סגירתה.
          </p>
          <p className="mt-2 rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs">
            ...
            ולא נשמר תוכן של שדות טופס כלשהם.
          </p>
        </Section>
