    ...
    <main className="min-h-screen page-wrap py-10">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <Section title="מה אנחנו אוספים">
          ...
          <p className="mt-4 font-bold text-slate-900">5. לוג השימוש</p>
          <p>
            אנו רושמים כיצד האתר בשימוש, כדי לדעת מה עובד ומה חסר: <strong>באילו עמודים
            צפיתם</strong>, <strong>כמה זמן שהיתם בכל עמוד</strong>, <strong>מה חיפשתם</strong>,
            ו<strong>סוג המכשיר</strong> (מובייל / טאבלט / מחשב).
          </p>
          <p className="mt-2">
            בנוסף נרשמים: <strong>עד כמה גללתם בעמוד</strong> (רבע / חצי / שלושה רבעים / עד הסוף),{" "}
            <strong>לחיצות על רשימה סגורה של כפתורים</strong> (הרשמה, התחברות, בדיקת מחיר,
            מחשבון, באנר הקורס וכדומה — לא כל לחיצה באתר),{" "}
            <strong>לחיצות חוזרות על אותו אלמנט</strong> שאינו מגיב, <strong>מסכי שגיאה שראיתם</strong>{" "}
            (מזהה התקלה בלבד), ו<strong>האתר שממנו הגעתם</strong>.
          </p>
          <p className="mt-2">
            האתר המפנה נשמר כ<strong>שם דומיין בלבד</strong> (למשל <span dir="ltr">google.com</span>) ולא
            ככתובת מלאה — כתובת חיפוש מלאה עלולה לשאת את מה שחיפשתם במנוע, ולזה אין לנו שימוש.
          </p>
          <p className="mt-2">
            נמדד גם <strong>עד לאן גללתם בעמוד</strong>, <strong>אילו חלקים בעמוד היו על המסך
            וכמה זמן</strong>, ו<strong>כמה זמן לקח לעמוד להיטען אצלכם</strong> — כדי לדעת אילו
            חלקים באתר נקראים בפועל ואיזה עמוד איטי מדי.
          </p>
          <p className="mt-2">
            כשאתם <strong>מחוברים לחשבון</strong>, הרישום הזה מקושר לחשבון שלכם ומפעילי האתר
            רואים אותו ברמת המשתמש. בגלישה ללא חשבון הרישום אינו מקושר לזהות כלשהי.
          </p>
          <p className="mt-2 rounded-lg border border-indigo-200 bg-indigo-50/60 p-3 text-xs">
            <strong>שני מזהים, ושניהם אקראיים.</strong> מזהה <strong>לשונית</strong> שנעלם עם
            סגירתה, ומזהה <strong>דפדפן</strong> שנשמר במכשיר שלכם ופג <strong>אחרי 180 יום</strong>.
            השני נועד לדבר אחד: להבדיל בין ״אדם אחד חזר חמש פעמים״ ל״חמישה אנשים נכנסו פעם אחת״.
            שניהם מספרים אקראיים — הם אינם נגזרים מהדפדפן, מהמסך או מכל מאפיין אחר, ולכן אינם
            טביעת אצבע ואי אפשר לשחזר אותם אם תמחקו אותם. הם אינם עוגיות, ולכן אינם נשלחים לאף
            אתר אחר. ניקוי נתוני האתר בדפדפן מוחק אותם לחלוטין.
          </p>
          <p className="mt-2 rounded-lg border border-emerald-200 bg-emerald-50/60 p-3 text-xs">
            <strong>עוגייה שלישית, ולא למדידה.</strong> כדי לאפשר לכם לפתוח שני עמודי ערים
            <strong> בלי להירשם</strong>, האתר שומר במכשירכם מזהה אקראי (עוגייה בשם{" "}
            <code dir="ltr">karnaf_anon</code>) שנועד לדבר אחד בלבד: לזכור אילו ערים כבר
            נפתחו לדפדפן הזה. היא פגה אחרי <strong>180 יום</strong>, אינה נקראת בכלל על ידי
            קוד שרץ בדפדפן (httpOnly), ואינה נשלחת לאף אתר אחר. היא אינה משמשת לפרסום,
            אינה מקושרת לזהות, ואינה נכנסת ללוג השימוש. <strong>בחרנו בה במפורש במקום
            זיהוי לפי כתובת IP</strong> — כתובת IP היא נתון אישי שאיננו אוספים, והיא גם
            משותפת לאלפי אנשים ברשתות סלולריות, כך שהיא הייתה חוסמת גולשים אחרים.
            ניקוי העוגיות בדפדפן מוחק אותה לחלוטין.
          </p>
          <p className="mt-2 rounded-lg border border-slate-200 bg-slate-50 p-3 text-xs">
            מה <strong>לא</strong> נשמר בלוג הזה, גם לא למשתמש מחובר: <strong>כתובת IP</strong>,{" "}
            <strong>מזהה הדפדפן (user-agent)</strong>, וכל טקסט חופשי מלבד מונחי החיפוש שהקלדתם.
            סוג המכשיר נשמר כקטגוריה אחת משלוש — לא כמאפיין שמאפשר לזהות מכשיר מסוים.
            זמן נמדד רק כשהלשונית גלויה, ולכל צפייה יש תקרה של 30 דקות.
            לחיצות נרשמות רק מהרשימה הסגורה שלמעלה — <strong>אין מאזין שרושם כל לחיצה</strong>,
            ולא נשמר תוכן של שדות טופס כלשהם. גודל המסך נשמר כקטגוריה ולא כמידות מדויקות.
          </p>
        </Section>
