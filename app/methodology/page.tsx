  ...
  return (
    <main className="min-h-screen page-wrap py-8">
      ...
      <Section icon="calculator" title="חישוב ממוצע וחציון">
        ...
        <p><B>שכונות:</B> אותו חישוב בדיוק ברמת שכונה×שנה, עם סף נפרד וגבוה יותר של <B>{NB_MIN_DEALS}+ עסקאות</B> לתא — תא שכונתי קטן, ועסקה חריגה אחת מזיזה אותו. ממוצע העיר שמוצג לצד טבלת השכונות מחושב מאותן עסקאות-שכונה בלבד, ולא ממספר העיר, שכולל גם עסקאות שלא נרשמה להן שכונה.</p>
      </Section>
